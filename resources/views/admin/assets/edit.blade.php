                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="number" id="total_quantity" name="total_quantity" placeholder="1" required
                                class="w-full px-4 py-4 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-gray-50 text-gray-900 placeholder:text-gray-400"
                                value="{{ old('total_quantity', $asset->total_quantity) }}">
                        ...
                        <div class="space-y-2">
                            ...
                            <select id="status" name="status" required
                                ...
                                <option value="Available" @if(old('status', $asset->status) == 'Available') selected @endif>Tersedia</option>
                                <option value="Damaged" @if(old('status', $asset->status) == 'Damaged') selected @endif>Rusak</option>
                                <option value="Borrowed" @if(old('status', $asset->status) == 'Borrowed') selected @endif>Dipinjam</option>
                            </select>
                            @error('status')
                            <div class="flex items-center mt-2 text-red-600 text-sm">
                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
