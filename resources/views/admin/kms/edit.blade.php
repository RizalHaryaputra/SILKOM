<x-admin-layout title="Edit Dokumen KMS">
    {{-- Script untuk Rich Text Editor (TinyMCE) --}}
    <script src="https://cdn.tiny.cloud/1/34g20fzax8dqgasgocu73owvzx09n1udj1ig3iie8zx8g8gu/tinymce/6/tinymce.min.js"
    ...
    <div class="max-w-4xl mx-auto p-4 sm:p-6 lg:px-8">
        <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
            <div class="p-8">
                ...
                <h2 class="text-xl font-bold text-gray-800 mb-6">Edit Dokumen</h2>
                ...
                <form method="POST" action="{{ route('admin.kms-documents.update', $kmsDocument->id) }}"
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" id="title" name="title" placeholder="Mis: Cara Mengatasi Error Printer"
                            ...
                            value="{{ old('title', $kmsDocument->title) }}">
                        @error('title')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <select id="category" name="category" required
                                ...
                                <option value="{{ $category }}" @if(old('category', $kmsDocument->category) ==
                        ...
                        {{-- Penulis --}}
                        <div class="space-y-2">
                            <label for="author" class="flex items-center text-sm font-semibold text-gray-700">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-4 h-4 mr-2 text-gray-500">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                Penulis</label>
                            <input type="text" id="author" name="author" placeholder="Mis: Cara Mengatasi Error Printer"
                                required
                                class="w-full px-4 py-4 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-gray-50 text-gray-900 placeholder:text-gray-400"
                                value="{{ old('author', $kmsDocument->author) }}">
                            @error('author')
                            <div class="flex items-center mt-2 text-red-600 text-sm">
                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="mt-2 p-4 bg-gray-50 border border-gray-200 rounded-xl">
                            <img src="{{ asset('storage/' . $kmsDocument->cover_image) }}" alt="Cover saat ini"
                    ...
                    {{-- Cover Image --}}
                    <div class="space-y-2">
                        <label for="cover_image" class="flex items-center text-sm font-semibold text-gray-700">Ganti
                            <svg class="w-4 h-4 mr-2 text-gray-500" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z">
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea id="content" name="content" rows="10"
                            ...
                            class="w-full px-4 py-4 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-gray-50 text-gray-900 placeholder:text-gray-400 resize-vertical">{{ old('content', $kmsDocument->content) }}</textarea>
                        @error('content')
                        <div class="flex items-center mt-2 text-red-600 text-sm">
                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
