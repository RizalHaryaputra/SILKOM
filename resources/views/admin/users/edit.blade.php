<x-admin-layout title="Edit Pengguna">
    ...
    <div class="max-w-4xl mx-auto p-4 sm:p-6 lg:px-8">
        <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
            <div class="p-8">
                ...
                <h2 class="text-xl font-bold text-gray-800 mb-6">Edit Pengguna: {{ $user->name }}</h2>
                ...
                <form method="POST" action="{{ route('admin.users.update', $user->id) }}" class="space-y-8">
                    ...
                    <div class="space-y-6 p-6 rounded-xl border border-gray-200">
                        ...
                        {{-- <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                <label for="password"
                                    class="flex items-center text-sm font-semibold text-gray-700">Password Baru
                                    (Opsional)</label>
                            ...
                            <div class="space-y-2">
                                <label for="password_confirmation"
                                    class="flex items-center text-sm font-semibold text-gray-700">Konfirmasi Password
                                    Baru</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                <label for="password"
                                    class="flex items-center text-sm font-semibold text-gray-700">Password Baru (Opsional)</label>
                                ...
                                <div class="relative">
                                    ...
                                    <button type="button" id="password_toggle"
                                        ...
                                        {{-- Ikon Mata (Default) --}}
                                        <svg id="eye_icon_password" xmlns="http://www.w3.org/2000/svg" fill="none"
                                        ...
                                        <svg id="eye_slash_icon_password" xmlns="http://www.w3.org/2000/svg" fill="none"
                            ...
                            <div class="space-y-2">
                                <label for="password_confirmation"
                                    class="flex items-center text-sm font-semibold text-gray-700">Konfirmasi Password Baru
                                    Password</label>
                                {{-- 1. Tambahkan div relative --}}
                                <div class="relative">
                    ...
                    <div class="space-y-6 p-6 rounded-xl border border-gray-200">
                        ...
                        <div class="space-y-2">
                            ...
                            <select id="role_select" name="role" required
                                ...
                                <option value="{{ $role->name }}" @if(old('role', $user->getRoleNames()->first()) ==
                                    $role->name) selected @endif>
                                    {{ $role->name }}
                                </option>
                                @endforeach
                            </select>
    ...
    @push('scripts')
    {{-- Skrip JS ini SAMA PERSIS dengan di halaman 'create' --}}
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Panggil saat halaman dimuat (untuk mengecek nilai 'selected')
            toggleStudentFields();
