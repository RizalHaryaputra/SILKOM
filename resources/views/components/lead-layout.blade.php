            ...
            <aside
                ...
                <div class="flex items-center px-5 py-6 shrink-0"
                    ...
                    <span class="font-bold text-lg text-white" x-show="!sidebarCollapsed" x-transition.opacity>
                        SILKOM <span class="block text-xs font-normal">Lead</span>
                    </span>
                ...
                <nav class="flex-1 px-4 space-y-2 overflow-y-auto">
                    ...
                    <a href="{{ route('lead.dashboard') }}"
                        class="flex items-center px-3 py-2 rounded-md transition-colors duration-200 {{ request()->routeIs('lead.dashboard') ? 'bg-blue-800 text-white' : 'hover:bg-blue-800 hover:text-white' }}"
                    ...
                    <a href="{{ route('lead.reports.index') }}"
                        class="flex items-center px-3 py-2 rounded-md transition-colors duration-200 {{ request()->routeIs('lead.reports.*') ? 'bg-blue-800 text-white' : 'hover:bg-blue-800 hover:text-white' }}"
                        :class="sidebarCollapsed && 'justify-center'">
                        <svg class="h-5 w-5 shrink-0" :class="!sidebarCollapsed && 'mr-3'"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <span class="whitespace-nowrap" x-show="!sidebarCollapsed" x-transition.fade>Laporan</span>
                    </a>
                </nav>
            </aside>
