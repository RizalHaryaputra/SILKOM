<x-staff-layout title="Pengajuan Alat Baru">

    <div class="max-w-4xl mx-auto p-4 sm:p-6 lg:px-8">
        <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
            <div class="p-8">
                
                <h2 class="text-xl font-bold text-gray-800 mb-6">Formulir Pengajuan Alat Baru</h2>
                ...
                <form method="POST" action="{{ route('staff.asset-requests.store') }}" class="space-y-8">
                    @csrf
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea id="reason" name="reason" rows="4"
                            ...
                            class="w-full px-4 py-4 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-gray-50 text-gray-900 placeholder:text-gray-400 resize-vertical">{{ old('reason') }}</textarea>
                        @error('reason')
                        <div class="flex items-center mt-2 text-red-600 text-sm">
                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                            {{ $message }}
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea id="specifications" name="specifications" rows="3"
                            ...
                            class="w-full px-4 py-4 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-gray-50 text-gray-900 placeholder:text-gray-400 resize-vertical">{{ old('specifications') }}</textarea>
